...
import { ArrowLeft, Plus, Tag, Trash2, X, Copy, Check } from 'lucide-react'
        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-gs-gray-600">Create and manage discount codes</p>
            </div>
            <button
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <div className="flex gap-3 text-sm text-gs-gray-600">
                          <span>Used: {discount.current_uses}{discount.max_uses ? `/${discount.max_uses}` : ''}</span>
                          {discount.athlete_id && (
            ...
            <div className="p-6">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gs-gray-700 mb-1">Value *</label>
                    <input
                      type="number"
                ...
                <div>
                  <label className="block text-sm font-medium text-gs-gray-700 mb-1">Max Uses (optional)</label>
                  <input
                    type="number"
